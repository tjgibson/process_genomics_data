...
tar -xzf hisat2-2.1.0.tar.gz
rm hisat2-2.1.0.tar.gz
...
./hisat2-2.1.0/hisat2 -p 8 -k 2 --no-mixed --no-discordant -x ${ref_name}/${ref_name}  -1 ./${r1} -2 ./${r2} -S ./${bn}.sam --un-gz ./${bn}_un.fastq.gz
